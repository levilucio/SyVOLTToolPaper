...
Previous research activities at the Modelling, Simulation and Design Lab at McGill University led to the creation of \textbf{AToM$^3$}~\cite{atom3:2002}. This visual editor allowed us to create DSLTrans transformations and contracts visually. AToM$^3$~\cite{atom3:2002}: AToM$^3$ is a
